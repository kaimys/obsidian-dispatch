...
| `/code-review <id>` | ticket card | criteria, plan, diff and seams → `## Code review` in the ticket, `open_findings`, card back to `<<S_DEV>>` when a criterion fails |
